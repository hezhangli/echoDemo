...
func (uc *UserCreate) SetQiniuFilePath(s string) *UserCreate {
	uc.mutation.SetQiniuFilePath(s)
	return uc
}

// SetQiniuTxPath sets the "qiniu_tx_path" field.
func (uc *UserCreate) SetQiniuTxPath(s string) *UserCreate {
	uc.mutation.SetQiniuTxPath(s)
	return uc
}
...
func (uc *UserCreate) SetWxID(s string) *UserCreate {
	uc.mutation.SetWxID(s)
	return uc
}

// SetCorpID sets the "corp_id" field.
func (uc *UserCreate) SetCorpID(s string) *UserCreate {
	uc.mutation.SetCorpID(s)
	return uc
}

// SetDeptID sets the "dept_id" field.
func (uc *UserCreate) SetDeptID(s string) *UserCreate {
	uc.mutation.SetDeptID(s)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.QiniuFilePath(); !ok {
		return &ValidationError{Name: "qiniu_file_path", err: errors.New(`ent: missing required field "User.qiniu_file_path"`)}
	}
	if _, ok := uc.mutation.QiniuTxPath(); !ok {
		return &ValidationError{Name: "qiniu_tx_path", err: errors.New(`ent: missing required field "User.qiniu_tx_path"`)}
	}
	...
	if _, ok := uc.mutation.WxID(); !ok {
		return &ValidationError{Name: "wx_id", err: errors.New(`ent: missing required field "User.wx_id"`)}
	}
	if _, ok := uc.mutation.CorpID(); !ok {
		return &ValidationError{Name: "corp_id", err: errors.New(`ent: missing required field "User.corp_id"`)}
	}
	if _, ok := uc.mutation.DeptID(); !ok {
		return &ValidationError{Name: "dept_id", err: errors.New(`ent: missing required field "User.dept_id"`)}
	}
	if _, ok := uc.mutation.CreatedAt(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.QiniuFilePath(); ok {
		_spec.SetField(user.FieldQiniuFilePath, field.TypeString, value)
		_node.QiniuFilePath = value
	}
	if value, ok := uc.mutation.QiniuTxPath(); ok {
		_spec.SetField(user.FieldQiniuTxPath, field.TypeString, value)
		_node.QiniuTxPath = value
	}
	...
	if value, ok := uc.mutation.WxID(); ok {
		_spec.SetField(user.FieldWxID, field.TypeString, value)
		_node.WxID = value
	}
	if value, ok := uc.mutation.CorpID(); ok {
